  ...
  return (
    <section id="pricing" style={{ background: BG, padding: "60px 20px" }}>
      {wrap(<>
        ...
        {[
          { n: "1", t: "Консультация", sub: "Первый шаг", price: "По запросу", period: "разово", items: ["Анализ образа жизни и целей", "Тесты осанки", "Комплекс упражнений 10–15 мин/день", "Рекомендации по питанию"] },
          { n: "2", t: "Выстрой базу", sub: "Системная работа", price: "По запросу", period: "/ месяц", items: ["Индивидуальная программа тренировок", "Разбор техники по видео", "План питания и восстановления", "1–2 созвона в месяц", "Ежедневная поддержка"] },
          { n: "3", t: "VIP с врачом", sub: "Максимальный результат", price: "По запросу", period: "/ месяц", items: ["Всё из «Выстрой базу»", "Тренировки 1 на 1", "Работа с врачом по анализам", "Подбор БАДов"] },
        ].map(plan => (
