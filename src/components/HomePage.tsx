...
const SERVICES = [
  ...
  },
  {
    ...
    desc: "Индивидуальная программа тренировок и питания под твою цель — веду с обратной связью и корректирую по ходу. Есть вариант полегче: сопровождение по питанию плюс программа тренировок, которую ты выполняешь сама.",
    price: "от 15 000 ₽",
    priceUsd: "≈ $170",
    perMonth: true,
    btnText: "Узнать подробнее →",
