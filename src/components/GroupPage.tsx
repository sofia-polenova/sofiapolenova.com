        ...
        <FadeIn>
          <div style={{ background: "#FAFAF7", border: "1px solid rgba(0,0,0,0.12)", padding: "26px 20px 22px" }}>
            ...
            <div style={{ marginBottom: 24 }}>
              <PriceRow label="1 раз в неделю" rub="≈ 8 400 ₽ / месяц" usd="$100 / месяц" />
              <PriceRow label="2 раза в неделю" rub="≈ 16 800 ₽ / месяц" usd="$200 / месяц" />
              <PriceRow label="3 раза в неделю" rub="≈ 25 300 ₽ / месяц" usd="$300 / месяц" />
